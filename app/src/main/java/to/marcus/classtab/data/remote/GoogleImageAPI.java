...
public interface GoogleImageAPI {
    @GET("v1?key=AIzaSyCKHoqK_ofLeaoRjsT7lNYeXOVjGKubpjE&cx=008509658288434337533:wweu7ml6wic&searchType=image&fileType=jpg&imgSize=large&imgType=face&imgColorType=gray&imgDominantColor=black&alt=json")
